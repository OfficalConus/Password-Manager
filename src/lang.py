...
STRINGS = {
    ...
    "vault_locked_desc": {"RU": "Используйте кнопку «Сохранить»\nв генераторе, чтобы разблокировать", "EN": "Use the «Save» button\nin the generator tab to unlock", "ZH": "使用生成器标签页中的\n「保存」按钮来解锁"},
    ...
    "tab_email": {"RU": "Email", "EN": "Email", "ZH": "电子邮件"},
    "email_title": {"RU": "Просмотр Email", "EN": "Read Email", "ZH": "阅读邮件"},
    "email_settings": {"RU": "Настройки IMAP", "EN": "IMAP Settings", "ZH": "IMAP设置"},
    "email_provider": {"RU": "Почта:", "EN": "Provider:", "ZH": "邮箱服务:"},
    "email_user": {"RU": "Email:", "EN": "Email:", "ZH": "邮箱:"},
    "email_pass": {"RU": "Пароль:", "EN": "Password:", "ZH": "密码:"},
    "email_subject": {"RU": "Тема:", "EN": "Subject:", "ZH": "主题:"},
    "email_message": {"RU": "Сообщение:", "EN": "Message:", "ZH": "消息:"},
    "email_fetch": {"RU": "Загрузить", "EN": "Fetch Inbox", "ZH": "获取收件箱"},
    "email_inbox": {"RU": "Входящие", "EN": "Inbox", "ZH": "收件箱"},
    "email_from": {"RU": "От", "EN": "From", "ZH": "发件人"},
    "email_loading": {"RU": "Загрузка...", "EN": "Loading...", "ZH": "加载中..."},
    "email_loaded": {"RU": "Загружено писем: {}", "EN": "Loaded {} messages", "ZH": "已加载 {} 封邮件"},
    "email_no_subject": {"RU": "(без темы)", "EN": "(no subject)", "ZH": "(无主题)"},
    "email_read_err": {"RU": "Ошибка чтения", "EN": "Read error", "ZH": "读取错误"},
    "egg_pin_title": {"RU": "Код доступа", "EN": "Access code", "ZH": "访问码"},
    "egg_pin_prompt": {"RU": "Введите PIN:", "EN": "Enter PIN:", "ZH": "输入PIN:"},
    "egg_pin_ok": {"RU": "OK", "EN": "OK", "ZH": "确定"},
    "egg_pin_wrong": {"RU": "Неверный PIN", "EN": "Wrong PIN", "ZH": "PIN错误"},
    "egg_game_title": {"RU": "Fragments Flight", "EN": "Fragments Flight", "ZH": "Fragments Flight"},
    "egg_game_hint": {"RU": "A / D — двигать полосу · 5× заголовок — выход", "EN": "A / D — move bar · 5× title to exit", "ZH": "A / D 移动条 · 标题点5次退出"},
    "egg_game_running": {"RU": "Ловите фрагменты!", "EN": "Catch the fragments!", "ZH": "接住碎片！"},
    "egg_game_win": {"RU": "100% — Победа!", "EN": "100% — You win!", "ZH": "100% — 胜利！"},
    "egg_game_bsod": {"RU": "BSOD — Game Over", "EN": "BSOD — Game Over", "ZH": "蓝屏 — 游戏结束"},
    "egg_game_restart_in": {"RU": "Перезапуск через {} с", "EN": "Restart in {} s", "ZH": "{} 秒后重启"},
    "egg_game_restart": {"RU": "Сброс", "EN": "Restart", "ZH": "重置"},
    "egg_frag_blue": {"RU": "синий +5%", "EN": "blue +5%", "ZH": "蓝 +5%"},
    "egg_frag_red": {"RU": "красный BSOD", "EN": "red game over", "ZH": "红 结束"},
    "egg_frag_pink": {"RU": "розовый −5%", "EN": "pink minus", "ZH": "粉 −5%"},
    "egg_frag_yellow": {"RU": "жёлтый −2%", "EN": "yellow bad", "ZH": "黄 −2%"},
    "egg_frag_minus": {"RU": "MINUS", "EN": "MINUS", "ZH": "MINUS"},
    "egg_frag_bad": {"RU": "BAD", "EN": "BAD", "ZH": "BAD"},
}
