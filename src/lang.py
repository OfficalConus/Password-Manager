...
STRINGS = {
    ...
    "email_title": {"RU": "Отправка Email", "EN": "Send Email", "ZH": "发送邮件"},
    "email_settings": {"RU": "Настройки SMTP", "EN": "SMTP Settings", "ZH": "SMTP设置"},
    "email_user": {"RU": "Email:", "EN": "Email:", "ZH": "邮箱:"},
    "email_pass": {"RU": "Пароль:", "EN": "Password:", "ZH": "密码:"},
    "email_compose": {"RU": "Письмо", "EN": "Compose", "ZH": "撰写"},
    "email_subject": {"RU": "Тема:", "EN": "Subject:", "ZH": "主题:"},
    "email_message": {"RU": "Сообщение:", "EN": "Message:", "ZH": "消息:"},
    "email_send": {"RU": "Отправить", "EN": "Send", "ZH": "发送"},
    "email_clear": {"RU": "Очистить", "EN": "Clear", "ZH": "清除"},
    "email_sent": {"RU": "Отправлено!", "EN": "Sent!", "ZH": "已发送!"},
    "email_send_err": {"RU": "Ошибка отправки", "EN": "Send error", "ZH": "发送错误"},
}
